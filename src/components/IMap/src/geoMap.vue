<template>
  ...
  <script lang="ts" setup>
    ...
    import mapData from './geo/china.json';
  
    function mian() {
      // dom
  
      const domEl = document.getElementById('stage');
      if(!domEl) return
      //创建渲染器
      ...
      //创建相机
      var camera = new THREE.PerspectiveCamera(75, domEl.clientWidth / domEl.clientHeight, 0.1, 100000);
